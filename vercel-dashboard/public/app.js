...
function topbarRight(user) {
  ...
  return `${userChip(user)}${user.isAdmin ? `<a class="btn btn-admin btn-sm" href="/admin" data-nav>${shield} Admin</a>` : ""}<a class="btn btn-ghost btn-sm" href="/auth/logout">Log out</a>`;
}
